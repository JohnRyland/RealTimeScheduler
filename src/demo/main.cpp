...
{
  k_log_early(SUCCESS, "[X] Initializing modules");
  initialize_modules();
  k_log_early(SUCCESS, "[X] Initialized modules");
...
/*
  ...
  k_log_early(NORMAL, "Press any key to start");
  getch();
*/

  k_log_early(NORMAL, "Press any key to continue");
  getch();
